...
<p class="webgl-note">Playable Unity WebGL build that runs in the browser, no install needed. Use the button in the lower-right of the build to go fullscreen.</p>

<iframe src="{{ site.baseurl }}/games/colorblind-test/index.html"
        class="webgl-embed" loading="lazy" allowfullscreen
        title="Colorblind Test playable build"></iframe>
