...
images:
  - src: "img/portfolio/skullcrusher/01.png"
    alt: "Skullcrusher — boss encounter"
  - src: "img/portfolio/skullcrusher/02.png"
    alt: "Skullcrusher — boss encounter, alternate angle"
  - src: "img/portfolio/skullcrusher/03.png"
    alt: "Skullcrusher — weapon and zombie enemy"
  - src: "img/portfolio/skullcrusher/04.png"
    alt: "Skullcrusher — lobby screen"
  - src: "img/portfolio/skullcrusher/05.png"
    alt: "Skullcrusher — main menu"
  - src: "img/portfolio/skullcrusher/06.png"
    alt: "Skullcrusher — street environment"
  - src: "img/portfolio/skullcrusher/07.png"
    alt: "Skullcrusher — zombie enemy"
collaborators:
  # Fill in your two teammates' details below, then remove these comments.
  # Schema: name (required), role (optional), url (optional — LinkedIn, GitHub, itch.io, etc.)
  # - name: "Teammate Name"
...
links:
  - label: "Play on Itch.io"
    url: "https://marccanalsp.itch.io/skullcrusher"
---
...
Built the atmospheric environments that carry the game's horror tone, and handled the lighting, using shadow, colour temperature, and practical light sources to reinforce tension and guide player attention through each area.

## Outcome

A complete, playable cooperative horror experience, available on Itch.io.
